              ...
              <CardContent className="space-y-6">
                ...
                <div className="mb-3">
                  <h1 className="text-2xl font-semibold">
                    <span className="text-4xl font-bold">30</span> business opportunities found for you
                  </h1>
                  <p className="text-sm text-muted-foreground mt-1">Select the ones you are interested in</p>
                </div>
                        ...
                        {results.map((result, index) => (
                          ...
                          >
                            ...
                            <div className="col-span-3 text-sm">{result.problem}</div>
                             <div className="col-span-4 text-sm font-bold text-black">{result.marketValue}</div>
